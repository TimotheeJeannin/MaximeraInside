...
function layout(p) {
  ...
  const placements = cells.flatMap((cell) => fillCell(cell, dims, p.mode, freeHeight));
  return { panels, cells, floorY, placements, dims, freeHeight };
}
...
function fillCell(cell, dims, mode, freeHeight) {
